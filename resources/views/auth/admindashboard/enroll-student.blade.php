                ...
                <form action="{{ route('students.store') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <select name="s_gradelvl" class="form-select">
                    ...
                    {{-- Consent (from DOCX text) --}}
                    <div>
                        <p class="mb-2">As the parent (or legal guardian) of the above-named learner, I hereby consent to
                            his/her enrollment at
                        ...
                        <ol class="mb-3">
                            ...
                            <li>I will be liable, and I am aware that failure to settle my financial obligations, the school
                                will execute legal actions against me,
                                therefore I will make sure to pay all fees within the said school year.</li>
                        </ol>
