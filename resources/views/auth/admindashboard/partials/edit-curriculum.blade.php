                     ...
                     <form  action="{{ route('admin.curriculum.store') }}" method="POST">
                        ...
                        @method('POST')
                            ...
                            <div class="mb-2">
                                ...
                                <select name="schoolyr_id" id="schoolyrSelect" class="form-select">
                                    ...
                                    @foreach($schoolyrs as $sy)
                                        <option value="{{ $sy->id }}" {{ $sy->id==$result->schoolyr_id?'selected':'' }} >
                                            {{ $sy->school_year}}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-2">
                                ...
                                <select name="grade_id" id="schoolyrSelect" class="form-select">
                                    ...
                                    @foreach($gradelvls as $gl)
                                        <option value="{{ $gl->id }}" {{ $gl->id==$result->grade_id?'selected':'' }}>
                                            {{ $gl->grade_level }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-2">
                                ...
                                <option value="{{ $f->id }}" {{ $f->id==$result->adviser_id?'selected':'' }}>
                                    {{ $fname }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="modal-footer mt-2">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal"> <a href="{{ route('admin.curriculum.index') }}">Back</a></button>
